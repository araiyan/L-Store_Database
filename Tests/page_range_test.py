...
class TestPageRange(unittest.TestCase):
    ...
    def test_write_base_record(self):
        page_range = PageRange(0, self.num_columns, self.bufferpool,  self.merge_queue)
    ...
    def test_serialize_base_record(self):
        page_range = PageRange(3, self.num_columns, self.bufferpool, self.merge_queue)
    ...
    def test_write_tail_record(self):
        page_range = PageRange(1, self.num_columns, self.bufferpool, self.merge_queue)
        # instantiate page
        for i in range(self.num_records):
            #print(f"Writing Record to PageRange: {self.records[i]}")
    ...
    def test_serialize(self):
        page_range = PageRange(2, self.num_columns, self.bufferpool, self.merge_queue)
        # instantiate page
        for i in range(self.num_records):
            #print(f"Writing Record to PageRange: {self.records[i]}")
            logical_rid = page_range.assign_logical_rid()
